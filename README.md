About napari-spacetx-explorer-feedstock
=======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-spacetx-explorer-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15342&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-spacetx-explorer-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-spacetx-explorer` can be installed with `conda`:
...
```
mamba install napari-spacetx-explorer
```

It is possible to list all of the versions of `napari-spacetx-explorer` available on your platform with `conda`:
...
```
mamba search napari-spacetx-explorer --channel conda-forge
```
...
mamba repoquery search napari-spacetx-explorer --channel conda-forge

# List packages depending on `napari-spacetx-explorer`:
mamba repoquery whoneeds napari-spacetx-explorer --channel conda-forge

# List dependencies of `napari-spacetx-explorer`:
mamba repoquery depends napari-spacetx-explorer --channel conda-forge
```
